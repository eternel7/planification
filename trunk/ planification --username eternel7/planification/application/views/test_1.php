...
<div id="notes_action_bar">
    <span id="opener" class="notes-opener notes-effect"><img src="<?php echo base_url(); ?>images/post-it.jpg" height="75px" width="75px" alt="Create a note" /><input type="hidden" id="z_index_max" name="z_index_max" value="0" /></span>
